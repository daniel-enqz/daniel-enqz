...
> big O notation describes growth rates, not absolute values), so input usually omitted to simplify the analysis. But still can be used in system design or big data processing scnearios.
